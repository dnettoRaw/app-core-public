# Aplicacao com comando, evento e query

[English](intermediate.en.md) | [Français](intermediate.fr.md) |
[Exemplo minimo](basic.pt.md) | [Guia](../guide.pt.md)

Parta do exemplo minimo, adicione dependencias JSON, declare duas capabilities e
registre apenas comportamento da aplicacao. A composicao do Runtime nao muda.
...
Adicione ao `application.toml` no lugar de `capabilities = []`:
...
Chamadas HTTP mutaveis devem fornecer chave de idempotencia. O handler valida o
payload da aplicacao, retorna fluxo controlado e emite um evento de fato; o
Runtime possui transporte, audit, persistencia e shutdown.
