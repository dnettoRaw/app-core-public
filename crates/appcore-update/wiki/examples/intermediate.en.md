# Activate, health-gate and roll back

[Português](intermediate.pt.md) | [Français](intermediate.fr.md) |
[Minimal example](basic.en.md) | [Guide](../guide.en.md)

Commit one healthy artifact, activate a replacement and roll it back when its
health gate fails.
...
Production flow must verify authenticity and run a bounded smoke test before
activation, then use a real health gate before commit.
