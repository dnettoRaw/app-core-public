...
Identifiant stable : **ACR-025**. Consultez le
[guide complémentaire d’architecture et d’intégration](https://wiki.appcore.dnettoraw.com/fr/crates/id/acr-025). Cet identifiant
