# CLI intermediaire avec `appcore-args`
...
Cette CLI de sauvegarde derive validation, aide et completion d'une seule
specification. L'execution reste du code applicatif explicite.
...
Le script genere appelle la commande cachee `complete`. Les candidats sont des
donnees imprimees une par ligne; l'entree utilisateur n'est jamais inseree dans
le code shell.
