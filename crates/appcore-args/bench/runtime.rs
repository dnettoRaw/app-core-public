...
//! Measures bounded raw command-line token parsing.
...
fn main() {
    ...
    for _ in 0..iterations {
        let _ = black_box(appcore_args::RawArgs::parse([
            "render",
            "--format",
            "pdf",
            "--output",
...
fn report(iterations: u64, total_ns: u128) {
    println!(
        "appcore-args::raw_args_parse_5 iterations={iterations} total_ns={total_ns} ns_per_iter={:.2}",
