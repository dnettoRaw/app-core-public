# Fichier de snapshot chiffre et atomique

[English](intermediate.en.md) | [Português](intermediate.pt.md) |
[Exemple minimal](basic.fr.md) | [Guide](../guide.fr.md)

Persistez un snapshot borne avec l'API de fichier atomique verifie. Le reader
authentifie l'envelope complet avant de retourner le plaintext.
...
En production, utilisez un path appartenant a l'installation. `write_atomic`
verifie le nouvel envelope avant le remplacement et `read_verified` refuse les
symlinks et les fichiers trop volumineux.
