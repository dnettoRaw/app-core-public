...
//! Measures distributed identifier validation.
...
fn main() {
    ...
    for _ in 0..iterations {
        let _ = black_box(appcore_types::validate_distributed_identifier(
            "BenchmarkId",
            black_box("bench.identifier-01"),
        ));
    }
...
fn report(iterations: u64, total_ns: u128) {
    println!(
        "appcore-types::distributed_identifier_validation iterations={iterations} total_ns={total_ns} ns_per_iter={:.2}",
