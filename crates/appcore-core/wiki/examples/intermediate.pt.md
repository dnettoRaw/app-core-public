# Dispatch de comando idempotente da aplicacao
...
O handler permanece deterministico e retorna fatos; idempotencia duravel,
publicacao de eventos e audit sao responsabilidades da composicao ao redor do
contrato.
