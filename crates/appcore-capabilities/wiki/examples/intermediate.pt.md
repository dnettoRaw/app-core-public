# Resolver capability mutavel protegida

[English](intermediate.en.md) | [Français](intermediate.fr.md) |
[Exemplo minimo](basic.pt.md) | [Guia](../guide.pt.md)

Resolva um comando local somente apos aplicar seus requisitos de idempotencia e
lease por servico.
...
Remover a chave de idempotencia ou usar lease expirada ou de outro holder rejeita
a requisicao antes da execucao do handler.
