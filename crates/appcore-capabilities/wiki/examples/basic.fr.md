# Capability locale minimale

[English](basic.en.md) | [Português](basic.pt.md) |
[Exemple intermediaire](intermediate.fr.md) | [Guide](../guide.fr.md)

Enregistrez et invoquez une capability de query saine et locale au processus.
...
Le registry refuse les doublons et ne selectionne jamais un provider distant.
