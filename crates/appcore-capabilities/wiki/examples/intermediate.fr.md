# Resoudre une capability mutable protegee

[English](intermediate.en.md) | [Português](intermediate.pt.md) |
[Exemple minimal](basic.fr.md) | [Guide](../guide.fr.md)

Resolvez une commande locale uniquement apres avoir applique ses exigences
d'idempotence et de lease par service.
...
Supprimer la cle d'idempotence ou utiliser une lease expiree ou detenue par un
autre core refuse la requete avant l'execution du handler.
