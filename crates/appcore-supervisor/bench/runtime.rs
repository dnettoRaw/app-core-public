...
//! Measures bounded restart policy construction and validation.

use appcore_supervisor::RestartPolicy;
...
fn main() {
    ...
    for _ in 0..iterations {
        let _ = black_box(RestartPolicy::bounded(5, Duration::from_secs(600)));
    }
...
fn report(iterations: u64, total_ns: u128) {
    println!(
        "appcore-supervisor::restart_policy_validation iterations={iterations} total_ns={total_ns} ns_per_iter={:.2}",
